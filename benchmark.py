...
-----
    ...
    uv run python benchmark.py --synthesizers gp hc   # pick specific synthesizers
...
DEFAULT_SYNTHESIZERS = ["gp", "random_search", "enumerative", "hc", "1p1"]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        metavar="NAME",
        help="Synthesizers to compare (default: gp random_search enumerative hc 1p1)",
    )
    parser.add_argument(
        "--examples",
