...
-----
    ...
    uv run python benchmark.py --synthesizers gp enumerative   # pick specific synthesizers
...
DEFAULT_SYNTHESIZERS = ["gp", "random_search", "enumerative"]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        metavar="NAME",
        help="Synthesizers to compare (default: gp random_search enumerative)",
    )
    parser.add_argument(
        "--examples",
