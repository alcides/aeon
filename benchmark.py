...
-----
    ...
    uv run python benchmark.py --synthesizers tdsyn gp   # pick synthesizers
...
DEFAULT_SYNTHESIZERS = ["tdsyn", "gp", "random_search", "enumerative", "hc", "1p1"]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        metavar="NAME",
        help="Synthesizers to compare (default: tdsyn gp random_search enumerative hc 1p1)",
    )
    parser.add_argument(
        "--examples",
