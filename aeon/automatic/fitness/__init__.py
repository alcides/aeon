...
from aeon.automatic.parameters import AMOUNT_TESTS
...
def evaluate(population, genetics):
    ...
    tests = generate_inputs(argument_typees, genetics.type_context, AMOUNT_TESTS)
    
    for individual in population:

        # Fill the holes of the declaration
        declaration = genetics.declaration.copy()
        synthesized = replace_holes(declaration, individual.synthesized)
