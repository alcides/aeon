...
@dataclass
@weight(59)
class Subtract(NumericalExpression):
    left: NumericalExpression
    right: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(49)
class Multiply(NumericalExpression):
    left: NumericalExpression
    right: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(7)
class Divide(NumericalExpression):
    left: NumericalExpression
    right: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(20)
class Invert(NumericalExpression):
    n: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(18)
class Double(NumericalExpression):
    n: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(9)
class Halve(NumericalExpression):
    n: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(18)
class Increment(NumericalExpression):
    """Increments a numerical value by 1."""
    x: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
        return increment(self.x.evaluate(**kwargs))

@dataclass
@weight(39)
class Decrement(NumericalExpression):
    """Decrements a numerical value by 1."""
    x: NumericalExpression
    def evaluate(self, *args, **kwargs) -> Numerical:
...
@dataclass
@weight(63)
class Crement(NumericalExpression):
...
@dataclass
@weight(3)
class Sign(NumericalExpression):
...
@dataclass
@weight(39)
class Hmirror(PieceExpression):
    """Mirrors a piece horizontally."""
    piece: PieceExpression
    def evaluate(self, *args, **kwargs) -> Piece:
        return hmirror(self.piece.evaluate(**kwargs))

@dataclass
@weight(47)
class Vmirror(PieceExpression):
    """Mirrors a piece vertically."""
    piece: PieceExpression
    def evaluate(self, *args, **kwargs) -> Piece:
        return vmirror(self.piece.evaluate(**kwargs))

@dataclass
@weight(35)
class Dmirror(PieceExpression):
    """Mirrors a piece along the main diagonal."""
    piece: PieceExpression
    def evaluate(self, *args, **kwargs) -> Piece:
        return dmirror(self.piece.evaluate(**kwargs))

@dataclass
@weight(13)
class Cmirror(PieceExpression):
    """Mirrors a piece along the anti-diagonal."""
    piece: PieceExpression
    def evaluate(self, *args, **kwargs) -> Piece:
        return cmirror(self.piece.evaluate(**kwargs))
...
@dataclass
@weight(42)
class Upscale(ElementExpression):
    """Upscales an element (grid or object) by a given factor."""
    element: ElementExpression
    factor: IntegerExpression
    def evaluate(self, *args, **kwargs) -> Element:
        return upscale(self.element.evaluate(**kwargs), self.factor.evaluate(**kwargs))
...
class FalseConstant(BooleanExpression):
    def evaluate(self, *args, **kwargs) -> Boolean: return False
    def __str__(self): return "False"

@dataclass
@weight(454)
class TrueConstant(BooleanExpression):
    def evaluate(self, *args, **kwargs) -> Boolean: return True
    def __str__(self): return "True"

@dataclass
@weight(230)
class ZeroConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 0
    def __str__(self): return "0"
    
@dataclass
@weight(186)
class OneConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 1
    def __str__(self): return "1"

@dataclass
@weight(196)
class TwoConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 2
    def __str__(self): return "2"

@dataclass
@weight(133)
class ThreeConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 3
    def __str__(self): return "3"

@dataclass
@weight(82)
class FourConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 4
    def __str__(self): return "4"
    
@dataclass
@weight(83)
class FiveConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 5
    def __str__(self): return "5"
    
@dataclass
@weight(28)
class SixConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 6
    def __str__(self): return "6"
    
@dataclass
@weight(17)
class SevenConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 7
    def __str__(self): return "7"
    
@dataclass
@weight(78)
class EightConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 8
    def __str__(self): return "8"

@dataclass
@weight(31)
class NineConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 9
    def __str__(self): return "9"
    
@dataclass
@weight(14)
class TenConstant(IntegerExpression):
    def evaluate(self, *args, **kwargs) -> Integer: return 10
...
class DownConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (1, 0)
    def __str__(self): return "(1,0)"
    
@dataclass
@weight(13)
class RightConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (0, 1)
...
class OriginConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (0, 0)
    def __str__(self): return "(0,0)"

@dataclass
@weight(43)
class UnityConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (1, 1)
...
class ZeroByTwoConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (0, 2)
    def __str__(self): return "(0,2)"

@dataclass
@weight(13)
class TwoByZeroConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (2, 0)
    def __str__(self): return "(2,0)"

@dataclass
@weight(11)
class TwoByTwoConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (2, 2)
    def __str__(self): return "(2,2)"

@dataclass
@weight(18)
class ThreeByThreeConstant(TupleExpression):
    def evaluate(self, *args, **kwargs) -> IntegerTuple: return (3, 3)
    def __str__(self): return "(3,3)"
...
def solve_task(task_id: str, max_depth: int = 2, population_size: int = 200, time_limit: int = 300):
    task = load_arc_task_by_id(task_id)
    
    grammar = extract_grammar([Expression, Identity, Add, Subtract, Multiply, Divide, Invert, Even, Double, Halve, Flip, Equality, Contained, Combine, Intersection, Difference, Dedupe, 
    Order, Repeat, Greater, Size, Merge, Maximum, Minimum, Valmax, Valmin, Argmax, Argmin, MostCommon, LeastCommon, Initset, Both, Either, Increment, Decrement, Crement, 
    Sign, Positive, Toivec, Tojvec, Sfilter, Mfilter, Extract, Totuple, First, Last, Insert, Remove, Other, Interval, Astuple, Product, Pair, Branch, Compose, Chain, Matcher, 
    Rbind, Lbind, Power, Fork, Apply, Rapply, Mapply, Papply, Mpapply, Prapply, Mostcolor, Leastcolor, Height, Width, Shape, Portrait, Colorcount, Colorfilter, Sizefilter, 
    Asindices, Ofcolor, Ulcorner, Urcorner, Llcorner, Lrcorner, Crop, Toindices, Recolor, Shift, Normalize, Dneighbors, Ineighbors, Neighbors, ObjectsFromGrid, Partition, Fgpartition, 
    Uppermost, Lowermost, Leftmost, Rightmost, Square, Vline, Hline, Hmatching, Vmatching, Manhattan, Adjacent, Bordering, Centerofmass, Palette, Numcolors, Color, Toobject, 
    Asobject, Rot90, Rot180, Rot270, Hmirror, Vmirror, Dmirror, Cmirror, Fill, Paint, Underfill, Underpaint, Hupscale, Vupscale, Upscale, Downscale, Hconcat, Vconcat, Subgrid, 
    Hsplit, Vsplit, Cellwise, Replace, Switch, Center, Position, Index, Canvas, Corners, Connect, Cover, Trim, Move, Tophalf, Bottomhalf, Lefthalf, Righthalf, Vfrontier, Hfrontier, 
    Backdrop, Delta, Gravitate, Inbox, Outbox, Box, Shoot, Occurrences, Frontiers, Compress, Hperiod, Vperiod, FalseConstant, TrueConstant, ZeroConstant, OneConstant, TwoConstant, 
    ThreeConstant, FourConstant, FiveConstant, SixConstant, SevenConstant, EightConstant, NineConstant, TenConstant, NegOneConstant, NegTwoConstant, DownConstant, RightConstant, 
    UpConstant, LeftConstant, OriginConstant, UnityConstant, NegUnityConstant, UpRightConstant, DownLeftConstant, ZeroByTwoConstant, TwoByZeroConstant, TwoByTwoConstant, 
    ThreeByThreeConstant, InputGrid], GridExpression)
    ...
    def train_fitness_function(individual: GridExpression) -> float:
        ...
        parsimony_coefficient = 0.0001 # A very small penalty
