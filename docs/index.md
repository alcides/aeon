...
| `Lock` / `Reader` / `Email` / `Downloader` / `Order` / `Stack` / `Deque` | Typestate protocols (LiquidJava ports) | [typestate-protocols.md](typestate-protocols) |
