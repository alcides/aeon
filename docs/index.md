...
| `Lock` / `Reader` / `Email` / `Downloader` / `Order` / `Stack` / `Deque` / `Iterator` | Typestate protocols (LiquidJava ports) | [typestate-protocols.md](typestate-protocols) |
